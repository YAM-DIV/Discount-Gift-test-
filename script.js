...
let rasca = document.querySelector('.rasca');
...
const checkBlackFillPercentage = () => {
  ...
  if (blackFillPercentage >= 45) {
    ...
    setTimeout(() => {
      scratchCard.classList.add('anim-card');
      scratchCard.style.opacity = "1";
      rasca.classList.add('active');
    }, 3000);
    ...
    scratchCardImage.style.opacity = "1";
